...
(async() => {
    ...
    app.message('?', async({
            ...
            if (new Date().getUTCHours() > 20) {
                say(`Hello <@${message.user}>, it's past 5pm in Rio de Janeiro. Click <https://open.spotify.com/track/45gBYIbizYRUtvVFsRIHAu?si=9d3eab54fc934411|here.>`)
            } else {
                say(`Sorry <@${message.user}>, back to work! It's not 5pm in Rio de Janeiro yet.`)
            }
        }
